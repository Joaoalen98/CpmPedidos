...
namespace CpmPedidos.Repository
{
    public class ProdutoMap : BaseDomainMap<Produto>
    {
        ...
        public override void Configure(EntityTypeBuilder<Produto> builder)
        {
            ...
            builder.Property(x => x.Codigo).HasColumnName("codigo").HasMaxLength(59).IsRequired();
            builder.Property(x => x.Descricao).HasColumnName("descricao").HasMaxLength(58).IsRequired();
            ...
            builder
                ...
                .UsingEntity<ImagemProduto>(
                    ...
                    x =>
                    {
                        ...
                        x.HasKey(f => new { f.IdProduto, f.IdImagem });
