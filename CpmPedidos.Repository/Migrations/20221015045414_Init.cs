        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ativo = table.Column<bool>(type: "bit", maxLength: 100, nullable: false),
                    criado_em = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nome = table.Column<string>(type: "nvarchar(58)", maxLength: 58, nullable: false),
                    codigo = table.Column<string>(type: "nvarchar(59)", maxLength: 59, nullable: false),
                    descricao = table.Column<string>(type: "nvarchar(58)", maxLength: 58, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_cidade = table.Column<int>(type: "int", maxLength: 90, nullable: false),
                    criado_em = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nome = table.Column<string>(type: "nvarchar(58)", maxLength: 58, nullable: false),
                    preco = table.Column<decimal>(type: "decimal(17,2)", precision: 17, scale: 2, nullable: false),
                    id_imagem = table.Column<int>(type: "int", maxLength: 90, nullable: false),
                    ativo = table.Column<bool>(type: "bit", nullable: false),
                    criado_em = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
